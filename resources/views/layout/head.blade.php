...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('mofi/assets/css/vendors/intltelinput.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('mofi/assets/css/vendors/sweetalert2.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('mofi/assets/css/vendors/prism.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('src/css/selectize.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('mofi/assets/css/vendors/quill.snow.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('mofi/assets/css/vendors/quill.bubble.css')}}">
